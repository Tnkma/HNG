# Generated by Django 5.1.2 on 2024-11-14 00:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ManyToManyField(related_name='tags', to='api.task')),
            ],
        ),
        migrations.AddIndex(
            model_name='task',
            index=models.Index(fields=['createdBy', 'title', 'createdAt', 'due_date'], name='api_task_created_6bccd1_idx'),
        ),
        migrations.AddIndex(
            model_name='assignedto',
            index=models.Index(fields=['task', 'user'], name='api_assigne_task_id_50434c_idx'),
        ),
